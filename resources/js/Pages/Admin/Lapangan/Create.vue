...
// ─── Submit Form ───────────────────────────────────────────────────────────
const submit = () => {
    form.post(route('admin.lapangan.store'), {
        forceFormData: true, // Memastikan data dikirim sebagai form-data (karena ada upload file)
    })
}
</script>
    ...
    <AdminLayout title="Tambah Lapangan">
        <div class="max-w-3xl mx-auto space-y-6">
            ...
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h3 class="text-lg font-bold text-cream-text">Tambah Lapangan Baru</h3>
                    <p class="text-cream-muted text-xs">Buat unit lapangan bulutangkis baru di dalam sistem.</p>
                </div>
            </div>
                ...
                <form @submit.prevent="submit" class="space-y-6">
                    ...
                    <div class="space-y-3">
                        <label class="block text-xs font-bold uppercase tracking-wider text-cream-muted">
                            Foto Lapangan <span class="text-red-500">*</span>
                        </label>
                        ...
                        <div class="flex flex-col md:flex-row gap-6 items-start">
                            ...
                            <div class="w-full md:w-48 h-32 rounded-2xl border border-cream-border bg-cream-bg flex items-center justify-center overflow-hidden shadow-cream flex-shrink-0">
                                ...
                                <div v-else class="text-center p-3 text-cream-muted">
                                    ...
                                    <span class="text-[10px] uppercase font-bold">No Image Selected</span>
                                </div>
                            </div>
                            ...
                            <div class="flex-1 w-full space-y-2">
                                <div class="relative w-full">
                                    ...
                                    >
                                        📤 Pilih Berkas Gambar (Max 2MB)
                                    </label>
                                </div>
                                <p class="text-[11px] text-cream-muted">Format gambar yang didukung: JPEG, PNG, JPG, WEBP.</p>
